...
macro(mz_auto_format _TARGET)
  ...
  if( MZ_UNCRUSTIFY_BIN AND MZ_DO_AUTO_FORMAT )
    configure_file(${MZ_TOOLS_PATH}/autoformat.c.in ${CMAKE_CURRENT_BINARY_DIR}/format_step.c)
  ...
  if( MZ_CPPLINT_BIN AND MZ_DO_CPPLINT )
    configure_file(${MZ_TOOLS_PATH}/autoformat.c.in ${CMAKE_CURRENT_BINARY_DIR}/lint_step.c)
