...
if(NOT HAS_MZ_3RDPARTY)
    ...
    if( IOS_PLATFORM )
        set(MZ_3RDPARTY_BASE $ENV{HOME}/.mz-3rdparty/${IOS_PLATFORM}-${CMAKE_SYSTEM_PROCESSOR})
    else()
        set(MZ_3RDPARTY_BASE $ENV{HOME}/.mz-3rdparty/${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR})
    endif()
